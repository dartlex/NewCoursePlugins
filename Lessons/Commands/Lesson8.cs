...
namespace Lessons.Commands
{
    ...
    public class Lesson8 : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            if (hasPickOne != null)
            {
                ...
                if (selectedElement is Wall selectedWall)
                {
                    ...
                    ICollection<Element> collection = collector.OfClass(typeof(FamilySymbol)).OfCategory(BuiltInCategory.OST_Windows).ToElements();
